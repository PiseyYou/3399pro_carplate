...
#define VEHICLE_NUM_RESULTS    1452//294
...
int LP_Recognition::process_init()
{
    ...
    const char *vehicle_model_path = "./Model/deploy_rm_detection_output.rknn";
    const char *vehicle_box_priors_path = "./Model/Vehicle_DetBox_0623.txt";
     ...
     )
{
    ...
    crop_rect.y = vehicleBox.y + crop_rect.height*arLoc_args[0]*2/3;
     ...
     )
{
     ...
     {
	rectangle(matPlatimg, Charboxes[i], cv::Scalar(0, 255, 255), 2);
